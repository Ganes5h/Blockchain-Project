  ...
  return (
    <>
      <ThemeProvider theme={theme}>
                  ...
                  <div class="container mx-auto flex lg:px-12 py-24 lg:mt-2 md:flex-row flex-col items-center my-10 px-4">
                    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                      ...
                      <p class="mb-8 leading-relaxed text-white font-montserrat">
                        Welcome to GovPramaan, a blockchain-based solution for
                        generating and validating digital certificates. Designed
                        for government offices, students, industries, and
                        educational institutes, our platform creates unique,
        ...
        <div className="landing-sec min-h-screen container">
          <Grid container>
            <Grid md={6} className="mt-12">
              <Typography
                variant="h2"
