...
import GovernmentDashboard from "../InstituteDashboard";
import GenerateCertGov from "../GenerateCertInstitute";
import VeryfyCertGov from "../VeryfyCertInstitute";
import AllGovCert from "../All_Institute_Cert";
import ProfileGov from "../ProfileInstitute";
import HelpnSupportGov from "../HelpnSupportInstitute";
...
const SideNavGov = () => {
  ...
  return (
    <div>
      ...
      >
        {selectedLink === "Dashboard" && <GovernmentDashboard />}
        {selectedLink === "GenerateCertificate" && <GenerateCertGov />}
        {selectedLink === "VerifyCertificate" && <VeryfyCertGov />}
        {selectedLink === "AllCertificates" && <AllGovCert/>}
        {selectedLink === "Profile" && <ProfileGov />}
        {selectedLink === "HelpSupport" && <HelpnSupportGov />}
      </div>
    </div>
  );
};
