...
import StudentHelpnSupport from "../StudentHelpnSupport";
...
const SideNavGov = () => {
  ...
  return (
    <div>
      ...
      >
        {selectedLink === "Dashboard" && <StudentCertificates />}
        ...
        {selectedLink === "Profile" && <StudentProfile />}
        {selectedLink === "HelpSupport" && <StudentHelpnSupport />}
      </div>
    </div>
  );
};
